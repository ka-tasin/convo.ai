...
//         };
//       } else {
//         // Update existing user - safely access properties
//         const user = allUsers[decoded.id];
//         if (user) {
...
//           const userLastSeen = allUsers[decoded.id]?.lastSeen || 0;
//           const userMessages = msgs.filter(
//             (msg) =>
//               msg.receiverId === decoded.id &&
//               !msg.isChatGPT &&
//               msg.timestamp > userLastSeen
//           );
