...
const ChatMessage = ({ text, isUser, isChatGPT }: ChatMessageProps) => {
  if (isChatGPT) {
    return (
      <div className="max-w-xs md:max-w-md lg:max-w-lg bg-gradient-to-r from-purple-100 to-blue-100 border border-purple-200 rounded-lg p-3 mx-auto">
        <div className="flex items-center mb-1">
          ...
          <span className="text-xs font-semibold text-purple-800">ChatGPT</span>
        </div>
